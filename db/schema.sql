...
CREATE TABLE IF NOT EXISTS bs_daily_prices (
    ...
    rs_1m       TINYINT UNSIGNED DEFAULT NULL COMMENT 'RS 1개월 백분위 0~99',
    rs_3m       TINYINT UNSIGNED DEFAULT NULL COMMENT 'RS 3개월 백분위 0~99',
    rs_6m       TINYINT UNSIGNED DEFAULT NULL COMMENT 'RS 6개월 백분위 0~99',
